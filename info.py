...
API_ID = int(environ.get('API_ID', '29732623'))
API_HASH = environ.get('API_HASH', 'c20d85c3b8edc9eb1cec121d52d7a449')
BOT_TOKEN = environ.get('BOT_TOKEN', "7783068727:AAH3oNvD0KYqwuMdCpLVzrGrPOSbnF95SlA")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6807190920').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6807190920').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002516688682'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002505727305').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002694785303') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://movieapp:movieapp@movieapp.p9glo.mongodb.net/?retryWrites=true&w=majority&appName=movieapp")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "movieapp")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+FKucNijxzHtlZTE8')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+FKucNijxzHtlZTE8')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'FKucNijxzHtlZTE8') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/+FKucNijxzHtlZTE8')
